...
const allTables: Record<string, any[]> = {
  "ZAL": [
    ...
    { id: 7, name: "Stol 7", status: "occupied", amount: "80.00 UZS", user: "Otabek", time: "19:00", people: 4, items: [{ name: "Norin", qty: 2, price: "60.00 UZS" }, { name: "Choy", qty: 1, price: "5.00 UZS" }] },
    { id: 8, name: "Stol 8", status: "occupied", amount: "40.00 UZS", user: "Otabek", time: "19:03", items: [{ name: "Lag'mon", qty: 2, price: "40.00 UZS" }] },
    { id: 9, name: "Stol 9", status: "special", amount: "95.00 UZS", user: "Otabek", time: "18:41", people: 2, hasCloud: true, items: [{ name: "Somsa", qty: 5, price: "95.00 UZS" }] },
    { id: 10, name: "Stol 10", status: "occupied", amount: "80.00 UZS", user: "Otabek", time: "19:03", items: [] },
  ...
  "ZAL 2": [
    ...
    { id: 23, name: "Stol-2 3", status: "occupied", amount: "120.00 UZS", user: "Sardor", time: "18:30", items: [{ name: "Qozon kabob", qty: 2, price: "120.00 UZS" }] },
  ...
  "TERRASA": [
    ...
    { id: 33, name: "Terrasa 3", status: "occupied", amount: "250.00 UZS", user: "Jasur", time: "19:15", items: [{ name: "Assorti", qty: 1, price: "150.00 UZS"}, { name: "Sharbat", qty: 2, price: "100.00 UZS"}] },
  ],
  "BOG'": [
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.tablesPanel}>
          <View style={styles.tablesHeader}>
            <Text style={styles.tablesHeaderBread}>Qavatlar &gt; <Text style={styles.tablesHeaderActive}>{activeCategory === 'BARCHA STOLLAR' ? 'Barcha stollar' : activeCategory}</Text></Text>
          </View>
            ...
            {displayedTables.map((t, idx) => {
              ...
              return (
                <View key={idx} style={styles.tableCardContainer}>
                  <TouchableOpacity 
                    style={{ flex: 1 }} 
                    onPress={() => t.status !== 'empty' && setSelectedOrder({ id: t.id, table: t.name, amount: t.amount, time: t.time, items: t.items || [] })}
                  >
                    <LinearGradient 
